...
Also [this pinned post in our community](https://thinktank.ottomator.ai/t/videos-tutorial-helpful-content/3243) has a bunch of incredible resources for running and deploying SmartCODE yourself!
...
Alternatively, you can download the latest version of the project directly from the [Releases Page](https://github.com/stackblitz-labs/SmartCODE/releases/latest). Simply download the .zip file, extract it, and proceed with the setup instructions below. If you are comfertiable using git then run the command below.

Clone the repository using Git:

```bash
git clone https://github.com/stackblitz-labs/SmartCODE
cd SmartCODE
```
...
There are two ways to configure your API keys in SmartCODE:
...
- On **Mac**, you can find the file at `[your name]/SmartCODE/.env.example`.
...
To keep your local version of SmartCODE up to date with the latest changes, follow these steps for your operating system:
...
This ensures that you're running the latest version of SmartCODE and can take advantage of all the newest features and bug fixes.

---

## Adding New LLMs

SmartCODE supports a modular architecture for adding new LLM providers and models. The system is designed to be easily extensible while maintaining consistency across all providers.
...
SmartCODE supports MCP (Model Context Protocol) servers to extend AI capabilities with external tools and services. MCP allows you to connect various tools and services that the AI can use during conversations.
...
SmartCODE provides comprehensive Git integration for version control, collaboration, and project management.
...
SmartCODE provides one-click deployment to popular hosting platforms, making it easy to share your projects with the world.
...
3. SmartCODE automatically builds and deploys your project
...
SmartCODE integrates with Supabase to provide backend database functionality, authentication, and real-time features for your applications.
...
SmartCODE uses WebContainer technology to provide a secure, isolated development environment with live preview capabilities.
...
SmartCODE comes with a comprehensive collection of starter templates to help you quickly bootstrap your projects. Choose from popular frameworks and technologies:
...
SmartCODE includes a convenient help icon (?) in the sidebar that provides quick access to comprehensive documentation. Simply click the help icon to open the full documentation in a new tab.
...
Here are some tips to get the most out of SmartCODE:
