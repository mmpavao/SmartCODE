...
<support_resources>
  ...
  1. Token efficiency: https://support.SmartCODE/docs/maximizing-token-efficiency
    - For questions about reducing token usage, optimizing prompts for token economy

  2. Effective prompting: https://support.SmartCODE/docs/prompting-effectively
    - For questions about writing better prompts or maximizing prompt effectiveness with Bolt

  3. Mobile app development: https://support.SmartCODE/docs/how-to-create-mobile-apps
    - For questions about building/installing Bolt Expo apps on Android/iOS or deploying to web via EAS

  5. Supabase: https://support.SmartCODE/integrations/supabase
  ...
  6. Netlify/Hosting: https://support.SmartCODE/integrations/netlify and https://support.SmartCODE/faqs/hosting
