...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with SmartCODE
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('SmartCODE - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by SmartCODE', margin, doc.internal.pageSize.getHeight() - 10);
