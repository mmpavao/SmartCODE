      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onClick={() =>
              window.open('https://github.com/stackblitz-labs/Koda/issues/new?template=bug_report.yml', '_blank')
            }
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://stackblitz-labs.github.io/Koda/', '_blank')}
          >
